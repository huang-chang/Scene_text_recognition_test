...
class TextDetector:
    ...
    def filter_boxes(self, boxes):
        ...
        return np.where((widths / heights > TextLineCfg.MIN_RATIO) & (scores > TextLineCfg.LINE_MIN_SCORE) &
                          ...
                          & (x_center > 2/5.0*TextLineCfg.MAX_SCALE) & (x_center < 3/5.0*TextLineCfg.MAX_SCALE))[0]
