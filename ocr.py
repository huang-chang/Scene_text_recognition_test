...
def charRec(img, text_recs, adjust=False):
   ...
   for index, rec in enumerate(text_recs):
       ...
       #print(partImg.shape, partImg.shape[0])
...
def model(img, adjust=False):
    ...
    result, densenet_time = charRec(img, text_recs, adjust)
    
    return result, img_framed, detect_time, detect_number,densenet_time , img.shape
